...
public class AddStudentView extends JDialog {
    ...
    JLabel homeLabel = new JLabel("课程名:",JLabel.RIGHT);
    JTextField homeTxt = new JTextField();
    JLabel cnLabel = new JLabel("课程编号",JLabel.RIGHT);
    JTextField cnTxt = new JTextField();
    JLabel mathLabel = new JLabel("班级号",JLabel.RIGHT);
    JTextField mathTxt = new JTextField();
    JLabel enLabel = new JLabel("成绩",JLabel.RIGHT);
    JTextField enTxt = new JTextField();
    JLabel seLabel = new JLabel("学期",JLabel.RIGHT);
    JTextField seTxt = new JTextField();
    JLabel traitLabel = new JLabel("课程性质",JLabel.RIGHT);
    JTextField traitTxt = new JTextField();
