...
import com.roadjava.student.view.PermissionManagePanel;
...
import static com.roadjava.util.DBUtil.getConn;
...
public class MainViewHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("增加".equals(text)) {
            ...
            mainView.setPageNow(mainView.getPageNow() + 1);
            mainView.reloadTable();
        }else if("权限分配".equals(text)) {
            mainView.setContentPane(new PermissionManagePanel(getConn()));
            mainView.getContentPane().setVisible(false);
        }
    }
}
